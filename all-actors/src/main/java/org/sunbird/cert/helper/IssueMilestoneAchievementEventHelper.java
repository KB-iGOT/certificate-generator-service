...
public class IssueMilestoneAchievementEventHelper {
    private static final Logger logger = LoggerFactory.getLogger(IssueMilestoneAchievementEventHelper.class);
    ...
    private static IssueMilestoneAchievementEventHelper instance = null;

    public static synchronized IssueMilestoneAchievementEventHelper getInstance() {
        if (instance == null) {
            instance = new IssueMilestoneAchievementEventHelper();
        }
        return instance;
    }

    private IssueMilestoneAchievementEventHelper() {}

    public static Map<String, Object> generateMilestoneAchievementMap(Map<String, Object> requestMap, Map<String, Object> template) {
        ...
        try {
            ...
            String milestoneAchievementName = (String)template.getOrDefault("name", "");
            ...
            if (!userDetails.isEmpty()) {
                return generateMilestoneAchievementEvent(
                        requestMap,
                        template,
                        userDetails,
                        milestoneAchievementName,
    ...
    private static Map<String, Object> validateEnrolmentCriteria(Map<String, Object> requestMap, Map<String, Object> enrollmentCriteria, String milestoneAchievementName, Map<String, List<String>> additionalProps) throws BaseException {
        ...
        if (MapUtils.isNotEmpty(enrollmentCriteria)) {
            ...
            if (row != null) {
                ...
                if (CollectionUtils.isNotEmpty(mapList)) {
                    ...
                    List<Map<String, String>> issuedMilestoneAchievements = (List<Map<String, String>>) map.getOrDefault("issued_milestone_achievements", new ArrayList<>());

                    boolean isMilestoneAchievementIssued = !issuedMilestoneAchievements.isEmpty() &&
                            issuedMilestoneAchievements.stream()
                                    .anyMatch(ma -> milestoneAchievementName.equalsIgnoreCase(ma.getOrDefault("name", "")));

                    int status = (int) map.getOrDefault("status", 0);
                    int criteriaStatus = (int) enrollmentCriteria.getOrDefault("status", 2);

                    String oldId = (isMilestoneAchievementIssued && reIssue) ?
                            issuedMilestoneAchievements.stream()
                                    .filter(ma -> milestoneAchievementName.equalsIgnoreCase(ma.getOrDefault("name", "")))
                                    .map(ma -> ma.getOrDefault("identifier", ""))
                                    .findFirst()
                                    .orElse("") : "";
    ...
    private static Map<String, Object> generateMilestoneAchievementEvent(Map<String, Object> requestMap, Map<String, Object> template, Map<String, Object> userDetails, String milestoneAchievementName, Map<String, Object> enrolledUser) throws UnirestException, IOException {
        ...
        eData.put("basePath", PropertiesCache.getInstance().getProperty("cert_domain_url") + "/milestoneAchievements");
    ...
    public Response fetchEventTemplate(String eventId, String batchId) throws BaseException {
        ...
        primaryKey.put(JsonKeys.BATCH_ID, batchId);
        return cassandraOperation.getRecordsByProperties(JsonKeys.COURSE_KEY_SPACE_NAME, JsonKeys.EVENT_BATCH, primaryKey, null);
    }

    public boolean isUserEligibleForEventMilestoneAchievement(Response row) throws BaseException {
        if (row != null) {
